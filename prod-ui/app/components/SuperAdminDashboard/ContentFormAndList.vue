  ...
  >
    <div class="w-full px-6">
      ...
      <div class="w-full">
        ...
        <div
          v-if="showForm"
          class="rounded-lg shadow-sm border mb-8 transition-colors duration-300 w-full"
        >
          <div class="px-6 py-4">
          ...
          <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-2 border rounded-md transition-colors duration-200   focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full px-4 py-2 border rounded-md transition-colors duration-200 resize-y   focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                disabled
                ></textarea>
            </div>
            ...
            <div>
              <label
                class="block text-sm font-medium mb-3 uppercase "
              >
                Categories
              </label>
            ...
            <div>
              <div class="flex items-center justify-between mb-2">
                ...
                <button
                  type="button"
                  @click="addLink"
                  class="inline-flex items-center px-3 py-1 text-sm rounded-md transition-colors duration-200"
                >
              ...
              >
                ...
                >
                  <input
                    ...
                    class="flex-1 px-3 py-2 bg-gray-900 border  rounded text-white text-sm"
                  />
                  <button
                    type="button"
            ...
            <div class="flex items-center gap-4 pt-4 border-t border-gray-700">
              ...
              <button
                type="button"
                @click="clearForm"
                class="px-6 py-3 border font-medium rounded-md transition-colors duration-200 bg-gray-700 border-gray-600  hover:bg-gray-600"
              >
