 ...
 * @param {string} endpoint - The API endpoint (e.g., 'techsavvy_app/cms/list/')
...
export const API_ENDPOINTS = {
  ...
  CMS: {
    ...
    DETAIL: (id) => `techsavvy_app/cms/${id}/`,
    CREATE: "techsavvy_app/cms/create/",
    EDIT: (id) => `techsavvy_app/cms/edit/${id}/`,
    DELETE: (id) => `techsavvy_app/cms/delete/${id}/`,
  },
