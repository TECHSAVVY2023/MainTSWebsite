...
export const SAMPLE_BRAND_LOGOS = {
  /** Remote placeholder avoids 404 when `public/assets/codebev-logo.png` is missing in a clone. */
  codebev: `https://images.unsplash.com/photo-1551434678-e076c223a692?${sq}`,
