    ...
    <main class="bg-neutral-gray pt-24 pb-16 sm:pt-28 sm:pb-20 md:pt-32 md:pb-24 relative overflow-hidden flex flex-col">
      ...
      <div class="relative z-10 isolate flex-1 flex flex-col">
        <div class="container mx-auto px-4 sm:px-6 lg:px-10 relative flex-1 flex flex-col">
          <section class="mb-6 relative z-10 bg-neutral-gray">
            <p class="text-xs font-semibold tracking-[0.25em] uppercase text-yellow-400">News &amp; Updates</p>
            <p v-if="!article" class="text-sm text-dark/60 mt-4">
          ...
          <section v-if="article" class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start max-w-[1200px] mx-auto">
            <div class="flex flex-col gap-6">
              ...
              />
              <div class="relative z-10 rounded-xl p-5 sm:p-6 bg-white border border-neutral-border shadow-sm">
                <h1 class="text-lg sm:text-xl font-bold leading-tight mb-2 text-dark">{{ article.title }}</h1>
                <a
                ...
                <p v-else class="text-sm leading-relaxed text-dark/60">
