  ...
  <div class="mx-auto w-full max-w-[72rem]">
    <div class="grid grid-cols-2 items-stretch gap-3 sm:gap-5 md:grid-cols-3 md:gap-6 lg:grid-cols-4">
      ...
      >
        ...
        <div class="relative -mt-10 flex justify-center px-3 sm:-mt-12 sm:px-4">
          <div class="relative">
            <div
            ...
            />
            <div
              class="relative overflow-hidden rounded-full ring-[4px] ring-white shadow-[0_12px_32px_rgba(46,19,104,0.18)] sm:ring-[5px]"
            >
              <img
                :src="getSpeakerImage(speaker)"
                :alt="speaker.name || 'Speaker photo'"
                class="block aspect-square h-24 w-24 object-cover sm:h-[7.25rem] sm:w-[7.25rem] md:h-[7.5rem] md:w-[7.5rem]"
                loading="lazy"
                decoding="async"
              />
            </div>
