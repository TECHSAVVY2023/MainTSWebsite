<template>
 ...
 Join the Tech Savvy community and level up your fullstack journey.
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <NuxtLink
              to="/membership"
              class="inline-flex items-center justify-center px-8 py-3.5 rounded-xl bg-violet-600 text-white font-bold text-sm tracking-wide shadow-[0_8px_24px_rgba(124,58,237,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-violet-700 hover:shadow-[0_12px_32px_rgba(124,58,237,0.45)] no-underline"
            >
              Join Community
            </NuxtLink>
            <a
